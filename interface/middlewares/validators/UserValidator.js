module.exports = (Validator) => {
    ...
    const user_create = Validator([
        body("username").exists().withMessage("Missing username").bail()
        ...
        body("password").exists().withMessage("Missing password").bail()
    ...
    const user_delete = Validator([
        param("id").exists().withMessage("Missing ID").bail()
